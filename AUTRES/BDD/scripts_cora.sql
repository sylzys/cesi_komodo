...
INSERT INTO "public"."demande" ("demandeid", "cliid", "utiid", "demandeetat", "demandedteadd") VALUES ('2', '1', '1', '60', '2012-10-27')
...
CREATE OR REPLACE VIEW "public"."getDetailsDemande" AS 
SELECT
