...
//			addTitlePage(document,new Date(),"plop","plop","plop");	
//			Image qr_image =createQrcode("plop");			 
//			
//			String[][] data = new String[2][4];
//			data[0][0] = new String("plop");
//			data[0][1] = new String("plop");
//			data[0][2] = new String("plop");
//			data[0][3] = new String("plop");
//			
//			data[1][0] = new String("plop");
//			data[1][1] = new String("plop");
//			data[1][2] = new String("plop");
//			data[1][3] = new String("plop");
//			
...
//	}
    ...
    public MyPdf(String name) {
        ...
        try
        {
            ...
            PdfWriter.getInstance(document, new FileOutputStream(FILE + "/" + name + ".pdf"));
            document.open();
        }catch(Exception e){
