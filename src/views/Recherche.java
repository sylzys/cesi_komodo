...
import classes.DevisPdf;
import classes.MyPdf;
import classes.NomenclaturePdf;
                ...
                for (int i = 0; i < list.size(); i++) {
                    ...
                    btnGoToCmd.addActionListener(new ActionListener() {
                        public void actionPerformed(ActionEvent arg0) {
                            ...
                            DevisPdf devPdf = new DevisPdf(Integer.toString(btn_temp.getId()));
                            devPdf.makePdfDevis();
                            devPdf = null;
                        }
                    });
                ...
                for (int i = 0; i < list.size(); i++) {
                    ...
                    btnGoToCmd.addActionListener(new ActionListener() {
                        public void actionPerformed(ActionEvent arg0) {
                            ...
                            btn_temp.getId();
                            //Fenetre.getInstance().RenewCmd(btn_temp.getId());
                            NomenclaturePdf nomPdf = new NomenclaturePdf(Integer.toString(btn_temp.getId()));
                            nomPdf.makePdfNomenclature();
                            nomPdf = null;
                            //makePdfNomenclature();
                        }
                    });
