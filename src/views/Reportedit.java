 ...
 * @author lavie
 */
public class Reportedit extends KContainer {
    ...
    private List<Interlocuteur> inter; 
        public Reportedit(UserActif user, Client cli, Enquete enq) {
        super();
        this.user = user;
        this.cli = cli;
        this.enq = enq;
    ...
    protected void initPanel(){
        ...
        JButton btnsubmit = new JButton("Modifier le rapport");
        ...
        txtdesc.setText(enq.getEnqdesc());
        ...
        {
            if(enq.getInterid() == in.getInterid())
            {
                cbinter.addItem(in.getInterid()+". "+in.getInterprenom() + " " + in.getInternom());  
                cbinter.setSelectedItem(in.getInterid()+". "+in.getInterprenom() + " " + in.getInternom());  
            }
            else
            {
                cbinter.addItem(in.getInterid()+". "+in.getInterprenom() + " " + in.getInternom());  
        ...
        TitledBorder title;
        title = BorderFactory.createTitledBorder("<html><h2>Modifier un rapport</h2></html>");
        ...
        btnsubmit.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent arg0) {
                ...
                if(txttitre.getText().equals("") || txtdesc.getText().equals("")||date.getDate() == null)
                {
                ...
                else
                {
                    ...
                    Boolean retour = rapport.updtbdd(enq);
                    if(retour == true)
                    {
                        JOptionPane jop = new JOptionPane();
                        jop.showMessageDialog(null, "Rapport modifié avec succès");
                        Fenetre fen = Fenetre.getInstance();
                        HibernateConnection hb = HibernateConnection.getInstance();
                    ...
                    {
                        JOptionPane jop = new JOptionPane();
                        jop.showMessageDialog(null, "Une erreur est survenue lors de la modification du rapport. Veuillez réessayer.");
                    }
                }   
            }
        });
